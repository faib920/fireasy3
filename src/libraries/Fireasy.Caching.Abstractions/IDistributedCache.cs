...
namespace Fireasy.Caching
{
    ...
    public interface IDistributedCache
    {
        ...
        Task<T> AddAsync<T>(string cacheKey, T value, TimeSpan? expire = null, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">取消操作的通知。</param>
        Task SetExpirationTimeAsync(string cacheKey, TimeSpan? expiration, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">取消操作的通知。</param>
        /// <returns></returns>
        Task<T> TryGetAsync<T>(string cacheKey, Func<Task<T>> valueCreator, TimeSpan? expiration = null, CancellationToken cancellationToken = default);
