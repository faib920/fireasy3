...
namespace Fireasy.Data
{
        ...
        ICloneable
    {
        ...
        /// <returns></returns>
        public static ParameterCollection With(object parameters)
        {
            ...
            {
                collection.Add(property.Name, property.GetValue(parameters));
            }
        ...
        /// <returns></returns>
        public static ParameterCollection With(IDictionary<string, object> dic)
        {
        ...
        {
            Guard.ArgumentNull(parameterName, nameof(parameterName));
