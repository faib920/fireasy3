...
namespace Fireasy.Data.Provider
{
    ...
    public class PostgreSqlProvider : ProviderBase
    {
        ...
        public override void Initialize(ProviderInitializeContext context)
        {
            ...
            context.Services.TryAddSingleton<ISyntaxProvider, PostgreSqlSyntax>();
            context.Services.TryAddSingleton<ISchemaProvider, PostgreSqlSchema>();
            context.Services.TryAddSingleton<IBatcherProvider, MySqlBatcher>();
            context.Services.TryAddSingleton<IRecordWrapper, PostgreSqlRecordWrapper>();
        }
    }
}
