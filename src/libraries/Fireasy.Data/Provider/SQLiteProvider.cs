...
namespace Fireasy.Data.Provider
{
    ...
    public class SQLiteProvider : ProviderBase
    {
        ...
        public override void Initialize(ProviderInitializeContext context)
        {
            ...
            context.Services.TryAddSingleton<ISyntaxProvider, SQLiteSyntax>();
            context.Services.TryAddSingleton<ISchemaProvider, SQLiteSchema>();
            context.Services.TryAddSingleton<IBatcherProvider, SQLiteBatcher>();
