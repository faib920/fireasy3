...
namespace Fireasy.Data.Provider
{
    ...
    public class FirebirdProvider : ProviderBase
    {
        ...
        public override void Initialize(ProviderInitializeContext context)
        {
            ...
            context.Services.AddSingleton<ISyntaxProvider, FirebirdSyntax>();
            context.Services.AddSingleton<ISchemaProvider, FirebirdSchema>();
            context.Services.AddSingleton<IRecordWrapper, GeneralRecordWrapper>();
        }
    }
}
