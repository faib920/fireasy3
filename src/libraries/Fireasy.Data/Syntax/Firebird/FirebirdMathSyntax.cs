...
namespace Fireasy.Data.Syntax
{
    ...
    /// Firebird数学函数语法解析。
    /// </summary>
    public class FirebirdMathSyntax : IMathSyntax
    {
        /// <summary>
        /// 两个表达式进行与运算。
        /// </summary>
        ...
        {
            return $"BIN_AND({sourceExp}, {otherExp})";
        }
        ...
        {
            return $"BIN_OR({sourceExp}, {otherExp})";
        }
        ...
        {
            throw new SyntaxNotSupportedException(nameof(BitNot));
        }
        ...
        {
            return $"BIN_XOR({sourceExp}, {otherExp})";
        }
        ...
        {
            return $"BIN_SHL({sourceExp}, {shiftExp})";
        }
        ...
        {
            return $"BIN_SHR({sourceExp}, {shiftExp})";
        }
