...
namespace Fireasy.Data.Syntax
{
    ...
    /// Firebird字符串函数语法解析。
    /// </summary>
    public class FirebirdStringSyntax : IStringSyntax
    {
        /// <summary>
        /// 取源表达式的子串。
        /// </summary>
        ...
        {
            throw new SyntaxNotSupportedException(nameof(TrimStart));
        }
        ...
        {
            throw new SyntaxNotSupportedException(nameof(TrimEnd));
        }
