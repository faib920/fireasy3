...
namespace Fireasy.Data.Syntax
{
    ...
    /// Dameng日期函数语法解析。
    /// </summary>
    public class DamengDateTimeSyntax : IDateTimeSyntax
    {
        /// <summary>
        /// 获取当前时间。
        /// </summary>
        ...
        {
            return $"TO_DATE(CONCAT({yearExp}, '-', {monthExp}, '-', {dayExp}, ' ', {hourExp}, ':', {minuteExp}, ':', {secondExp}), 'YYYY-MM-DD HH24:MI:SS')";
        }
        ...
        {
            return $"DATEPART(YEAR, {sourceExp})";
        }
        ...
        {
            return $"DATEPART(MONTH, {sourceExp})";
        }
