...
namespace Fireasy.Data.Syntax
{
    ...
    public class PostgreSqlSyntax : ISyntaxProvider
    {
        ...
        /// 获取字符串函数相关的语法。
        /// </summary>
        public virtual IStringSyntax String => new PostgreSqlStringSyntax();

        /// <summary>
        /// 获取日期函数相关的语法。
        /// </summary>
        public virtual IDateTimeSyntax DateTime => new PostgreSqlDateTimeSyntax();

        /// <summary>
        /// 获取数学函数相关的语法。
        /// </summary>
        public virtual IMathSyntax Math => new PostgreSqlMathSyntax();
        ...
        /// </summary>
        /// <returns></returns>
        public string NewGuid => "SELECT GEN_RANDOM_UUID()";
