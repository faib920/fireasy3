...
namespace Fireasy.Data.Syntax
{
    ...
    public class OracleSyntax : ISyntaxProvider
    {
        ...
        /// 获取字符串函数相关的语法。
        /// </summary>
        public virtual IStringSyntax String => new OracleStringSyntax();

        /// <summary>
        /// 获取日期函数相关的语法。
        /// </summary>
        public virtual IDateTimeSyntax DateTime => new OracleDateTimeSyntax();

        /// <summary>
        /// 获取数学函数相关的语法。
        /// </summary>
        public virtual IMathSyntax Math => new OracleMathSyntax();
