...
namespace Fireasy.Data.Syntax
{
    ...
    /// SqlServer日期函数语法解析。
    /// </summary>
    public class SqlServerDateTimeSyntax : IDateTimeSyntax
    {
        /// <summary>
        /// 获取当前时间。
        /// </summary>
        ...
        {
            return $"CAST(CONCAT({yearExp}, '-', {monthExp}, '-', {dayExp}) AS DATETIME)";
        }
        ...
        {
            return $"CAST(CONCAT({yearExp}, '-', {monthExp}, '-', {dayExp}, ' ', {hourExp}, ':', {minuteExp}, ':', {secondExp}) AS DATETIME)";
        }
