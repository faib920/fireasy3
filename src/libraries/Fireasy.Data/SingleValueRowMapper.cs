...
namespace Fireasy.Data
{
    ...
    public class SingleValueRowMapper<T> : IDataRowMapper<T>
    {
        ...
        public SingleValueRowMapper(IServiceProvider serviceProvider)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static IDataRowMapper Create(IServiceProvider serviceProvider)
        {
            ...
            return new SingleValueRowMapper<T>(serviceProvider);
        }
