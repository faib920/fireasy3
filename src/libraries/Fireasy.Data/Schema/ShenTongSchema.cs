...
{
    /// <summary>
    /// ShenTong 数据库架构信息的获取方法。
    /// </summary>
    public sealed class ShenTongSchema : SchemaBase
    {
        /// <summary>
        /// 初始化约定查询限制。
        /// </summary>
        ...
        protected override void InitializeDataTypes()
        {
            ...
            AddDataType("float4", DbType.Decimal, typeof(decimal));
            AddDataType("float8", DbType.Decimal, typeof(decimal));
            AddDataType("hpfloat", DbType.Single, typeof(float));
            AddDataType("int1", DbType.Byte, typeof(byte));
            ...
            AddDataType("intervaldts", DbType.Time, typeof(TimeSpan), true);
            AddDataType("intervalytm", DbType.Int64, typeof(long), true);
            AddDataType("label", DbType.String, typeof(string));
            ...
            AddDataType("timetz", DbType.DateTime, typeof(DateTime));
            AddDataType("timestamp", DbType.DateTime, typeof(DateTime));
            AddDataType("timestamptz", DbType.DateTime, typeof(DateTime));
            AddDataType("varbinary", DbType.Binary, typeof(byte[]));
            AddDataType("varchar", DbType.String, typeof(string));
            AddDataType("xml", DbType.String, typeof(string));
        }
