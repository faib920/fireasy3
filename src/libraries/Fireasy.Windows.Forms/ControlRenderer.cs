...
namespace Fireasy.Windows.Forms
{
    ...
    {
        public RenderEventArgs(Graphics graphics, Rectangle rect)
        {
            Bounds = rect;
            Graphics = graphics;
        }
    ...
    {
        public BorderRenderEventArgs(IBorderStylization control, Graphics graphics, Rectangle rect)
            : base(graphics, rect)
        {
            Control = control;
        }
    ...
    {
        public BackgroundRenderEventArgs(IBackgroundAligning control, Graphics graphics, Rectangle rect)
            : base(graphics, rect)
        {
            Control = control;
        }
