...
namespace Fireasy.Common.Collections
{
    ...
    public class ExtraConcurrentDictionary<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>>
    {
        private readonly LazyThreadSafetyMode _mode = LazyThreadSafetyMode.ExecutionAndPublication;

        /// <summary>
        /// 实例化 <see cref="ExtraConcurrentDictionary{TKey, TValue}"/> 类的新实例。 
        /// </summary>
        public ExtraConcurrentDictionary()
        {
        ...
        public ExtraConcurrentDictionary(IEqualityComparer<TKey> comparer)
        {
        ...
        /// <param name="comparer"></param>
        public ExtraConcurrentDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey> comparer)
            : this(comparer)
        {
            if (collection != null)
            {
        ...
        /// </summary>
        /// <param name="collection"></param>
        public ExtraConcurrentDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection)
            : this()
        {
            if (collection != null)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ExtraConcurrentDictionary<TKey, TValue> TryRemoveDiscreated()
        {
